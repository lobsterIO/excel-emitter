...
import uk.co.spudsoft.birt.emitters.excel2.AreaBorders;
import uk.co.spudsoft.birt.emitters.excel2.Coordinate;
...
import uk.co.spudsoft.birt.emitters.excel2.Area;
import uk.co.spudsoft.birt.emitters.excel2.BirtStyle;
import uk.co.spudsoft.birt.emitters.excel2.CellImage;
import uk.co.spudsoft.birt.emitters.excel2.ClientAnchorConversions;
import uk.co.spudsoft.birt.emitters.excel2.EmitterServices;
import uk.co.spudsoft.birt.emitters.excel2.ExcelEmitter;
import uk.co.spudsoft.birt.emitters.excel2.HandlerState;
import uk.co.spudsoft.birt.emitters.excel2.RichTextRun;
import uk.co.spudsoft.birt.emitters.excel2.StyleManager;
import uk.co.spudsoft.birt.emitters.excel2.StyleManagerUtils;
